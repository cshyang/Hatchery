...
const runnerDeps = { triggerApiUrl: 'https://trigger', triggerSecretKey: 'tr_secret', githubToken: 'ghp_x', runnerToken: 't', moreHandsPublicUrl: 'https://hatchery', fetch: async () => new Response('{}') };
