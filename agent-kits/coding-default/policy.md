...
description: Guardrails for Pi coding runs launched by Hatchery.
---

# Coding Default Policy

Hatchery is the control plane. The external runner is the execution plane.
...
- Callback Hatchery only with boundary status and artifact metadata.
...
4. Runner opens a PR and calls Hatchery with status, branch, commit, PR, CI, sandbox, summary, or error metadata.
